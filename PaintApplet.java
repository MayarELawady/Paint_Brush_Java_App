...
import java.awt.Checkbox;
 ...
 public class PaintApplet extends Applet  
 {
	 ...
	 public void init(){
			 ...
			 btnFreeHand = new Button("FreeHand Drawing");
			 add(btnFreeHand);
			...
			Filled = new Checkbox("Fill");
				add(Filled);
					Filled.addItemListener(new ItemListener(){
						public void itemStateChanged(ItemEvent e){
						Checkbox clicked_one = (Checkbox) e.getItemSelectable();
	...
	class DrawingListener implements MouseListener,MouseMotionListener 
	  {
		public void mousePressed  ( MouseEvent e)// same in all shapes 
			 { 
					switch (shapeMode) {
